...
import com.example.android.architecture.blueprints.todoapp.data.FakeRemoteDataSource;
...
public class AddEditTaskScreenTest {
    ...
    public void toolbarTitle_editTask_persistsRotation() {
        ...
        FakeRemoteDataSource.getInstance().addTasks(new Task("Title1", "", TASK_ID, false));
