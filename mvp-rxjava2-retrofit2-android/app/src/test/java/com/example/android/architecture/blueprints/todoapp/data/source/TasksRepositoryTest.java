...
public class TasksRepositoryTest {
    ...
    public void setupTasksRepository() {
        ...
        mTasksRepository = Repository.getInstance(
    ...
    private void setTasksNotAvailable(DataSource dataSource) {
        when(dataSource.getTasks()).thenReturn(Flowable.just(Collections.emptyList()));
    }

    private void setTasksAvailable(DataSource dataSource, List<Task> tasks) {
    ...
    private void setTaskNotAvailable(DataSource dataSource, String taskId) {
        when(dataSource.getTask(eq(taskId))).thenReturn(Flowable.just(Optional.absent()));
    }

    private void setTaskAvailable(DataSource dataSource, Optional<Task> taskOptional) {
